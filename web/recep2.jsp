<%-- 
    Document   : recep2
    Created on : Nov 6, 2018, 3:48:29 PM
    Author     : home
--%>
...
#lobtn:hover {
    ...
    <body>
        <center>
               ...
               <br></br>
               <form action="recep2a.jsp" method="POST">
               ...
               <br></br>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3 id="container">Out-Patient Details</h3>
    <%
try {
...
String QueryString = "select p.*,t.a_id,t.p_diagnosis from patient p,patientsummary t where p.p_id=t.p_id and t.p_category='Out-Patient'";
...
<TR>
<TD><FORM ACTION="recep.jsp" method="get" >
