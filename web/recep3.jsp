<%-- 
    Document   : recep2a
    Created on : Nov 6, 2018, 3:48:43 PM
    Author     : home
--%>
...
#lobtn:hover {
    ...
    <body>
        <center>
               ...
               <br></br>
               <form action="recep3a.jsp" method="POST">
               ...
               <br></br>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3 id="container">In-Patient Details</h3>
    <%
try {
...
String QueryString = "select p.*,t.a_id,t.p_diagnosis from patient p,patientsummary t where p.p_id=t.p_id and p_category='In-Patient'";
